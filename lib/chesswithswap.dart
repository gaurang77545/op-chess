...
class ChessWithSwap extends StatefulWidget {
  String currfirstcolor;
  String currsecondcolor;
  ChessWithSwap(this.currfirstcolor, this.currsecondcolor);

  @override
  _ChessWithSwapState createState() => _ChessWithSwapState();
}

class _ChessWithSwapState extends State<ChessWithSwap> {
                          ...
                          child: ChessBoard(
                            ...
                            onMove: () {
                              ...
                              if (controller.isCheckMate()) {
                                ...
                                print(winner);
                                DateTime time = DateFormat("hh:mm:ss.SSS").parse(
                                    winner == 1 ? currtimefirst : currtimesecond);
